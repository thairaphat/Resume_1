...
export default function more2_project()  {
  return (
    ...
    >
      ...
      <div className="">
        ...
        <div className="pt-6">
          ...
          <img src="/project2_w7.png" alt="Two each of gray, white, and black shirts laying flat." className="hidden size-full rounded-lg object-cover lg:block" />
          <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
            <img src="/project2_w2.png" alt="Model wearing plain black basic tee." className="aspect-3/2 w-full rounded-lg object-cover" />
            <img src="/project2_w6.png" alt="Model wearing plain gray basic tee." className="aspect-3/2 w-full rounded-lg object-cover" />
          </div>
          
          <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
            <img src="/project2_w4.png" alt="Model wearing plain black basic tee." className="aspect-3/2 w-full rounded-lg object-cover" />
            <img src="/project2_w5.png" alt="Model wearing plain gray basic tee." className="aspect-3/2 w-full rounded-lg object-cover" />
          </div>
        </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center ">
                  ...
                  <img src="/logoflutter.png" alt="Description" />
                  <img src="/node_logo.png" alt="Description" />
                  <img src="/logo_mariadb.png" alt="Description" />
